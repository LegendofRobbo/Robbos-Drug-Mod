...
ENT.PrintName = "Muscle Relaxant" -- dont change anything here except for this name
...
ENT.DrugDescription = "A muscle relaxant drug that reduces the amount of damage\nrecieved from falls, bumps and speeding vehicles" -- its description, remember to use newline (/n) to make multiple lines
