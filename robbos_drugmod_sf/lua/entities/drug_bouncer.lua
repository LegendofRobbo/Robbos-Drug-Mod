...
ENT.PrintName = "Bouncer" -- dont change anything here except for this name
...
ENT.DrugDescription = "Bouncer is an odd drug that somehow allows you to jump higher and change direction midair\nOnly the manufacturer understands how it actually works" -- its description, remember to use newline (/n) to make multiple lines
