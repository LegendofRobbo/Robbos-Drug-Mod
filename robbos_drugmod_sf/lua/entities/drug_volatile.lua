...
ENT.PrintName = "Volatile Waste" -- dont change anything here except for this name
...
ENT.DrugModel = "models/props/cs_militia/paintbucket01.mdl"
...
ENT.DrugDescription = "A tin of volatile waste, drink it to become explosive\nBe careful! the tin is flammable!" -- its description, remember to use newline (/n) to make multiple lines
