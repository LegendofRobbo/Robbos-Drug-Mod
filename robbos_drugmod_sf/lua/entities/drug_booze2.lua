...
ENT.PrintName = "Moonshine" -- dont change anything here except for this name
...
ENT.DrugModel = "models/props_junk/garbage_glassbottle002a.mdl"
...
-- clientside only
ENT.DrugColor = Color(85, 85, 255) -- the colour of the title text
ENT.DrugDescription = "Far stronger than regular beer, this stuff is not for the faint of heart\nGets you plastered right off the bat and gives you 10% damage resist" -- its description, remember to use newline (/n) to make multiple lines
