...
ENT.PrintName = "Painkillers" -- dont change anything here except for this name
...
ENT.DrugDescription = "A vial of morphine based painkillers\nNumbs you to any further pain, increasing your overall toughness" -- its description, remember to use newline (/n) to make multiple lines
