...
ENT.PrintName = "Crystal Meth" -- dont change anything here except for this name
...
ENT.DrugModel = "models/katharsmodels/contraband/metasync/blue_sky.mdl"
...
ENT.DrugDescription = "A bag of crystal meth\nAllows you to punch people with the strength of a thousand angry baboons" -- its description, remember to use newline (/n) to make multiple lines
