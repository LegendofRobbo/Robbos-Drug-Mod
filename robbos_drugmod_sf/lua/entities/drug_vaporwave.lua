...
ENT.PrintName = "ｖａｐｏｒｗａｖｅ" -- dont change anything here except for this name
...
ENT.DrugModel = "models/props/cs_office/radio.mdl"
ENT.DrugModelColor = Color(255,255,255)
ENT.DrugSound = "vo/npc/male01/yeah02.wav" -- the sound the drug makes when you use it
ENT.DrugEffect = "Vaporwave" -- what effect it gives you
ENT.DrugTime = 120 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(255,90,255) -- the colour of the title text
ENT.DrugDescription = "ａｅｓｔｈｅｔｉｃ ａｓ ｆｕｃｋ" -- its description, remember to use newline (/n) to make multiple lines
