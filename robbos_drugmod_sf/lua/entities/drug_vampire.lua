...
ENT.PrintName = "Haemophage" -- dont change anything here except for this name
...
ENT.DrugModelColor = Color(155,55,55)
ENT.DrugSound = "npc/barnacle/barnacle_gulp1.wav" -- the sound the drug makes when you use it
ENT.DrugEffect = "Vampire" -- what effect it gives you
ENT.DrugTime = 120 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(155,55,55) -- the colour of the title text
ENT.DrugDescription = "Haemophage is an experimental drug that gives you vampiric powers\nAllowing you to regenerate yourself when you injure others" -- its description, remember to use newline (/n) to make multiple lines
