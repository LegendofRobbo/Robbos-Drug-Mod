...
ENT.PrintName = "Beer" -- dont change anything here except for this name
...
ENT.DrugModel = "models/props_junk/GlassBottle01a.mdl"
...
ENT.DrugEffect = "Drunk" -- what effect it gives you
ENT.DrugTime = 40 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(55, 55, 255) -- the colour of the title text
ENT.DrugDescription = "A bottle of fancy imported beer\nGets you plastered if you drink enough and gives you 10% damage resist" -- its description, remember to use newline (/n) to make multiple lines
