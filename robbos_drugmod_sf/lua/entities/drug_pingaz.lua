...
ENT.PrintName = "Pingaz" -- dont change anything here except for this name
...
ENT.DrugModel = "models/smile/smile.mdl"
...
ENT.DrugEffect = "Pingaz" -- what effect it gives you
ENT.DrugTime = 120 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(255, 225, 5) -- the colour of the title text
ENT.DrugDescription = "Pingaz (AKA. Ecstasy)\nA party drug that's fun for the whole family" -- its description, remember to use newline (/n) to make multiple lines
