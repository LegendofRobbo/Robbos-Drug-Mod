...
ENT.PrintName = "Vitalex" -- dont change anything here except for this name
...
ENT.DrugDescription = "Vitalex is a cocktail of painkillers, anti-inflammatories and regenerative agents\n that will quickly get you back on your feet after a beating" -- its description, remember to use newline (/n) to make multiple lines
